...
public class ApplicationContextAwareImpl implements ApplicationContextAware {
	private final Logger log = LoggerFactory.getLogger(ApplicationContextAwareImpl.class);

	/**
	 * 实现该接口用来初始化应用程序上下文 该接口会在执行完毕@PostConstruct的方法后被执行
	 * <p>
	...
	public void setApplicationContext(@Nullable ApplicationContext applicationContext) throws BeansException {
		...
		// log.info("应用程序上下文 getAutowireCapableBeanFactory ：
		// [{}]",applicationContext.getAutowireCapableBeanFactory());
		// log.info("应用程序上下文 getDisplayName ：
		...
		// log.info("应用程序上下文 getEnvironment ：
